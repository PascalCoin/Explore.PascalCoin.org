                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="nav nav-pills nav-pills-rose mb-5">
                                ...
                                <li class="nav-item">
                                    <router-link
                                            :to="{name: 'charts-blocktime', query: { type: 'monthly'} }"
                                            class="nav-link"
                                            exact-active-class="active show">
                                        Monthly
                                    </router-link>
                                ...
                                <li class="nav-item">
                                    <router-link
                                            :to="{name: 'charts-blocktime', query: { type: 'weekly'} }"
                                            class="nav-link"
                                            exact-active-class="active show">
                                        Weekly
                                    </router-link>
                                ...
                                <li class="nav-item">
                                    <router-link
                                            :to="{name: 'charts-blocktime', query: { type: 'daily'} }"
                                            class="nav-link"
                                            exact-active-class="active show">
                                        Daily
                                    </router-link>
  ...
  methods: {
    ...
    updateChart(data, xField, xLabel) {
      ...
      for (let i = 0; i < data.length; i += 1) {
        ...
        series.duration.data.push(parseFloat(data[i].avg_duration));
        // series.duration_avg.data.push(parseFloat(data[i].avg_duration));
