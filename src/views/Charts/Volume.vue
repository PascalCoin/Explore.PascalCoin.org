                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="nav nav-pills nav-pills-rose mb-5">
                                ...
                                <li class="nav-item">
                                    <router-link
                                            :to="{name: 'charts-volume', query: { type: 'monthly'} }"
                                            class="nav-link"
                                            exact-active-class="active show">
                                        Monthly
                                    </router-link>
                                ...
                                <li class="nav-item">
                                    <router-link
                                            :to="{name: 'charts-volume', query: { type: 'weekly'} }"
                                            class="nav-link"
                                            exact-active-class="active show">
                                        Weekly
                                    </router-link>
                                ...
                                <li class="nav-item">
                                    <router-link
                                            :to="{name: 'charts-volume', query: { type: 'daily'} }"
                                            class="nav-link"
                                            exact-active-class="active show">
                                        Daily
                                    </router-link>
  ...
  methods: {
    ...
    updateChart(data, xField, xLabel) {
      ...
      for (let i = 0; i < data.length; i += 1) {
        ...
        series.volume.data.push(data[i].sum_volume_pasc);
        series.volume_avg.data.push(data[i].avg_volume_pasc);
